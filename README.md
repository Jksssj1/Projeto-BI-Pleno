...
```
cd existing_repo
git remote add origin https://gitlab.com/challenge4835111/easy_cleaning.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/challenge4835111/easy_cleaning/-/settings/integrations)
